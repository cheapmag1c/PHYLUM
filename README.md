...
![Current PHYLUM world](renders/current.svg?gen=000023)

<!-- PHYLUM:STATE:START -->
**Observation:** `23`  
**Simulated time:** `day 28` / `year 0.08`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `894`  
**Occupied cells:** `56` / `1440`  
**Active pathogens:** `1`  
**Predator/prey links:** `0`  
**Dominant lineage:** `pale filament`  
**Last checkpoint Δ:** `+1` organisms · `+5` occupied cells  
**Latest fossil:** VIVARIUM advances 14 simulated days to year 0.08.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000023)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000023)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000023)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000023)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000023)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000023)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000023)
...
Continuous time: **day 28 / year 0.08** at observation **23**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
