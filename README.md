...
![Current PHYLUM world](renders/current.svg?gen=000112)

<!-- PHYLUM:STATE:START -->
**Observation:** `112`  
**Simulated time:** `day 1274` / `year 3.54`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `785`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 3.54.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000112)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000112)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000112)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000112)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000112)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000112)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000112)
...
Continuous time: **day 1274 / year 3.54** at observation **112**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
