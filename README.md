...
![Current PHYLUM world](renders/current.svg?gen=000189)

<!-- PHYLUM:STATE:START -->
**Observation:** `189`  
**Simulated time:** `day 2352` / `year 6.53`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `912`  
...
**Latest fossil:** cold fever emerges in world.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000189)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000189)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000189)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000189)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000189)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000189)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000189)
...
Continuous time: **day 2352 / year 6.53** at observation **189**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
