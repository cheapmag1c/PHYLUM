...
![Current PHYLUM world](renders/current.svg?gen=000061)

<!-- PHYLUM:STATE:START -->
**Observation:** `61`  
**Simulated time:** `day 560` / `year 1.56`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `874`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 1.56.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000061)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000061)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000061)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000061)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000061)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000061)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000061)
...
Continuous time: **day 560 / year 1.56** at observation **61**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
