...
![Current PHYLUM world](renders/current.svg?gen=000029)

<!-- PHYLUM:STATE:START -->
**Observation:** `29`  
**Simulated time:** `day 112` / `year 0.31`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `926`  
**Occupied cells:** `77` / `1440`  
**Active pathogens:** `1`  
**Predator/prey links:** `0`  
**Dominant lineage:** `pale filament`  
**Last checkpoint Δ:** `+4` organisms · `+3` occupied cells  
**Latest fossil:** VIVARIUM advances 14 simulated days to year 0.31.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000029)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000029)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000029)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000029)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000029)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000029)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000029)
...
Continuous time: **day 112 / year 0.31** at observation **29**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
