...
![Current PHYLUM world](renders/current.svg?gen=000150)

<!-- PHYLUM:STATE:START -->
**Observation:** `150`  
**Simulated time:** `day 1806` / `year 5.02`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `829`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 5.02.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000150)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000150)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000150)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000150)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000150)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000150)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000150)
...
Continuous time: **day 1806 / year 5.02** at observation **150**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
