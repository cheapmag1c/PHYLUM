...
![Current PHYLUM world](renders/current.svg?gen=000103)

<!-- PHYLUM:STATE:START -->
**Observation:** `103`  
**Simulated time:** `day 1148` / `year 3.19`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `796`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 3.19.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000103)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000103)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000103)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000103)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000103)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000103)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000103)
...
Continuous time: **day 1148 / year 3.19** at observation **103**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
