...
![Current PHYLUM world](renders/current.svg?gen=000126)

<!-- PHYLUM:STATE:START -->
**Observation:** `126`  
**Simulated time:** `day 1470` / `year 4.08`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `798`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 4.08.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000126)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000126)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000126)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000126)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000126)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000126)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000126)
...
Continuous time: **day 1470 / year 4.08** at observation **126**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
