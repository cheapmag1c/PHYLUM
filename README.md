...
![Current PHYLUM world](renders/current.svg?gen=000075)

<!-- PHYLUM:STATE:START -->
**Observation:** `75`  
**Simulated time:** `day 756` / `year 2.10`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `861`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 2.10.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000075)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000075)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000075)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000075)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000075)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000075)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000075)
...
Continuous time: **day 756 / year 2.10** at observation **75**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
