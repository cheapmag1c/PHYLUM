...
![Current PHYLUM world](renders/current.svg?gen=000127)

<!-- PHYLUM:STATE:START -->
**Observation:** `127`  
**Simulated time:** `day 1484` / `year 4.12`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `795`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 4.12.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000127)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000127)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000127)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000127)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000127)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000127)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000127)
...
Continuous time: **day 1484 / year 4.12** at observation **127**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
