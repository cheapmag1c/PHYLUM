...
![Current PHYLUM world](renders/current.svg?gen=000172)

<!-- PHYLUM:STATE:START -->
**Observation:** `172`  
**Simulated time:** `day 2114` / `year 5.87`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `888`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 5.87.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000172)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000172)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000172)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000172)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000172)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000172)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000172)
...
Continuous time: **day 2114 / year 5.87** at observation **172**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
