...
![Current PHYLUM world](renders/current.svg?gen=000115)

<!-- PHYLUM:STATE:START -->
**Observation:** `115`  
**Simulated time:** `day 1316` / `year 3.66`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `784`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 3.66.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000115)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000115)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000115)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000115)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000115)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000115)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000115)
...
Continuous time: **day 1316 / year 3.66** at observation **115**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
