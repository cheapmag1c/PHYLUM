...
![Current PHYLUM world](renders/current.svg?gen=000162)

<!-- PHYLUM:STATE:START -->
**Observation:** `162`  
**Simulated time:** `day 1974` / `year 5.48`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `874`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 5.48.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000162)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000162)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000162)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000162)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000162)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000162)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000162)
...
Continuous time: **day 1974 / year 5.48** at observation **162**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
