...
![Current PHYLUM world](renders/current.svg?gen=000097)

<!-- PHYLUM:STATE:START -->
**Observation:** `97`  
**Simulated time:** `day 1064` / `year 2.96`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `802`  
...
**Latest fossil:** pale spore emerges in world.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000097)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000097)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000097)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000097)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000097)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000097)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000097)
...
Continuous time: **day 1064 / year 2.96** at observation **97**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
