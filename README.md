...
![Current PHYLUM world](renders/current.svg?gen=000129)

<!-- PHYLUM:STATE:START -->
**Observation:** `129`  
**Simulated time:** `day 1512` / `year 4.20`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `800`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 4.20.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000129)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000129)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000129)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000129)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000129)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000129)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000129)
...
Continuous time: **day 1512 / year 4.20** at observation **129**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
