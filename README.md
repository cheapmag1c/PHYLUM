...
![Current PHYLUM world](renders/current.svg?gen=000193)

<!-- PHYLUM:STATE:START -->
**Observation:** `193`  
**Simulated time:** `day 2408` / `year 6.69`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `908`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 6.69.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000193)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000193)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000193)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000193)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000193)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000193)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000193)
...
Continuous time: **day 2408 / year 6.69** at observation **193**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
