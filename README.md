...
![Current PHYLUM world](renders/current.svg?gen=000095)

<!-- PHYLUM:STATE:START -->
**Observation:** `95`  
**Simulated time:** `day 1036` / `year 2.88`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `803`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 2.88.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000095)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000095)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000095)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000095)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000095)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000095)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000095)
...
Continuous time: **day 1036 / year 2.88** at observation **95**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
