...
![Current PHYLUM world](renders/current.svg?gen=000183)

<!-- PHYLUM:STATE:START -->
**Observation:** `183`  
**Simulated time:** `day 2268` / `year 6.30`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `892`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 6.30.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000183)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000183)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000183)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000183)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000183)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000183)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000183)
...
Continuous time: **day 2268 / year 6.30** at observation **183**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
