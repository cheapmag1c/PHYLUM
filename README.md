...
![Current PHYLUM world](renders/current.svg?gen=000114)

<!-- PHYLUM:STATE:START -->
**Observation:** `114`  
**Simulated time:** `day 1302` / `year 3.62`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `783`  
...
**Last checkpoint Δ:** `-3` organisms · `-1` occupied cells  
**Latest fossil:** VIVARIUM advances 14 simulated days to year 3.62.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000114)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000114)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000114)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000114)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000114)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000114)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000114)
...
Continuous time: **day 1302 / year 3.62** at observation **114**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
