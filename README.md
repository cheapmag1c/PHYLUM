...
![Current PHYLUM world](renders/current.svg?gen=000158)

<!-- PHYLUM:STATE:START -->
**Observation:** `158`  
**Simulated time:** `day 1918` / `year 5.33`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `863`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 5.33.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000158)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000158)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000158)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000158)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000158)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000158)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000158)
...
Continuous time: **day 1918 / year 5.33** at observation **158**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
