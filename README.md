...
![Current PHYLUM world](renders/current.svg?gen=000180)

<!-- PHYLUM:STATE:START -->
**Observation:** `180`  
**Simulated time:** `day 2226` / `year 6.18`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `887`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 6.18.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000180)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000180)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000180)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000180)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000180)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000180)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000180)
...
Continuous time: **day 2226 / year 6.18** at observation **180**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
