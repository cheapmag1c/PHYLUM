...
![Current PHYLUM world](renders/current.svg?gen=000157)

<!-- PHYLUM:STATE:START -->
**Observation:** `157`  
**Simulated time:** `day 1904` / `year 5.29`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `861`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 5.29.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000157)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000157)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000157)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000157)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000157)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000157)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000157)
...
Continuous time: **day 1904 / year 5.29** at observation **157**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
