...
![Current PHYLUM world](renders/current.svg?gen=000099)

<!-- PHYLUM:STATE:START -->
**Observation:** `99`  
**Simulated time:** `day 1092` / `year 3.03`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `795`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 3.03.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000099)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000099)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000099)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000099)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000099)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000099)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000099)
...
Continuous time: **day 1092 / year 3.03** at observation **99**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
