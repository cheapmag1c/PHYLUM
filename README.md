...
![Current PHYLUM world](renders/current.svg?gen=000074)

<!-- PHYLUM:STATE:START -->
**Observation:** `74`  
**Simulated time:** `day 742` / `year 2.06`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `860`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 2.06.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000074)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000074)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000074)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000074)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000074)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000074)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000074)
...
Continuous time: **day 742 / year 2.06** at observation **74**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
