...
![Current PHYLUM world](renders/current.svg?gen=000120)

<!-- PHYLUM:STATE:START -->
**Observation:** `120`  
**Simulated time:** `day 1386` / `year 3.85`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `785`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 3.85.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000120)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000120)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000120)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000120)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000120)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000120)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000120)
...
Continuous time: **day 1386 / year 3.85** at observation **120**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
