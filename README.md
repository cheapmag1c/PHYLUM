...
![Current PHYLUM world](renders/current.svg?gen=000169)

<!-- PHYLUM:STATE:START -->
**Observation:** `169`  
**Simulated time:** `day 2072` / `year 5.76`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `889`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 5.76.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000169)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000169)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000169)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000169)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000169)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000169)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000169)
...
Continuous time: **day 2072 / year 5.76** at observation **169**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
