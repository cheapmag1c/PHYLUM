...
![Current PHYLUM world](renders/current.svg?gen=000144)

<!-- PHYLUM:STATE:START -->
**Observation:** `144`  
**Simulated time:** `day 1722` / `year 4.78`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `825`  
...
**Last checkpoint Δ:** `+9` organisms · `+0` occupied cells  
**Latest fossil:** VIVARIUM advances 14 simulated days to year 4.78.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000144)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000144)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000144)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000144)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000144)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000144)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000144)
...
Continuous time: **day 1722 / year 4.78** at observation **144**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
