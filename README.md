...
![Current PHYLUM world](renders/current.svg?gen=000171)

<!-- PHYLUM:STATE:START -->
**Observation:** `171`  
**Simulated time:** `day 2100` / `year 5.83`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `891`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 5.83.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000171)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000171)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000171)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000171)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000171)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000171)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000171)
...
Continuous time: **day 2100 / year 5.83** at observation **171**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
