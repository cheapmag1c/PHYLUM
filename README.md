...
![Current PHYLUM world](renders/current.svg?gen=000107)

<!-- PHYLUM:STATE:START -->
**Observation:** `107`  
**Simulated time:** `day 1204` / `year 3.34`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `786`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 3.34.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000107)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000107)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000107)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000107)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000107)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000107)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000107)
...
Continuous time: **day 1204 / year 3.34** at observation **107**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
