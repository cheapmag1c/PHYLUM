...
![Current PHYLUM world](renders/current.svg?gen=000039)

<!-- PHYLUM:STATE:START -->
**Observation:** `39`  
**Simulated time:** `day 252` / `year 0.70`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `926`  
...
**Last checkpoint Δ:** `-4` organisms · `+1` occupied cells  
**Latest fossil:** VIVARIUM advances 14 simulated days to year 0.70.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000039)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000039)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000039)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000039)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000039)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000039)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000039)
...
Continuous time: **day 252 / year 0.70** at observation **39**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
