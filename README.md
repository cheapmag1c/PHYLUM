...
![Current PHYLUM world](renders/current.svg?gen=000106)

<!-- PHYLUM:STATE:START -->
**Observation:** `106`  
**Simulated time:** `day 1190` / `year 3.31`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `784`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 3.31.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000106)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000106)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000106)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000106)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000106)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000106)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000106)
...
Continuous time: **day 1190 / year 3.31** at observation **106**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
