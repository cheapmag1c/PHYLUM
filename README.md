...
![Current PHYLUM world](renders/current.svg?gen=000049)

<!-- PHYLUM:STATE:START -->
**Observation:** `49`  
**Simulated time:** `day 392` / `year 1.09`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `903`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 1.09.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000049)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000049)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000049)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000049)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000049)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000049)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000049)
...
Continuous time: **day 392 / year 1.09** at observation **49**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
