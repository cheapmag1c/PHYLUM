...
![Current PHYLUM world](renders/current.svg?gen=000040)

<!-- PHYLUM:STATE:START -->
**Observation:** `40`  
**Simulated time:** `day 266` / `year 0.74`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `923`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 0.74.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000040)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000040)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000040)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000040)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000040)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000040)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000040)
...
Continuous time: **day 266 / year 0.74** at observation **40**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
