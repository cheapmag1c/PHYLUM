...
![Current PHYLUM world](renders/current.svg?gen=000032)

<!-- PHYLUM:STATE:START -->
**Observation:** `32`  
**Simulated time:** `day 154` / `year 0.43`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `937`  
...
**Last checkpoint Δ:** `+2` organisms · `+1` occupied cells  
**Latest fossil:** VIVARIUM advances 14 simulated days to year 0.43.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000032)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000032)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000032)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000032)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000032)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000032)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000032)
...
Continuous time: **day 154 / year 0.43** at observation **32**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
