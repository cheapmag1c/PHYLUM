...
![Current PHYLUM world](renders/current.svg?gen=000086)

<!-- PHYLUM:STATE:START -->
**Observation:** `86`  
**Simulated time:** `day 910` / `year 2.53`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `836`  
**Occupied cells:** `82` / `1440`  
**Active pathogens:** `1`  
**Predator/prey links:** `0`  
**Dominant lineage:** `glass mote`  
**Last checkpoint Δ:** `-6` organisms · `-1` occupied cells  
**Latest fossil:** VIVARIUM advances 14 simulated days to year 2.53.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000086)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000086)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000086)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000086)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000086)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000086)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000086)
...
Continuous time: **day 910 / year 2.53** at observation **86**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
