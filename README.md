...
![Current PHYLUM world](renders/current.svg?gen=000083)

<!-- PHYLUM:STATE:START -->
**Observation:** `83`  
**Simulated time:** `day 868` / `year 2.41`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `844`  
...
**Last checkpoint Δ:** `-6` organisms · `-2` occupied cells  
**Latest fossil:** VIVARIUM advances 14 simulated days to year 2.41.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000083)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000083)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000083)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000083)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000083)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000083)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000083)
...
Continuous time: **day 868 / year 2.41** at observation **83**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
