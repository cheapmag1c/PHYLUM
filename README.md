...
![Current PHYLUM world](renders/current.svg?gen=000035)

<!-- PHYLUM:STATE:START -->
**Observation:** `35`  
**Simulated time:** `day 196` / `year 0.54`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `937`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 0.54.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000035)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000035)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000035)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000035)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000035)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000035)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000035)
...
Continuous time: **day 196 / year 0.54** at observation **35**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
