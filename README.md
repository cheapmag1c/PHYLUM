...
![Current PHYLUM world](renders/current.svg?gen=000066)

<!-- PHYLUM:STATE:START -->
**Observation:** `66`  
**Simulated time:** `day 630` / `year 1.75`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `865`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 1.75.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000066)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000066)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000066)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000066)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000066)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000066)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000066)
...
Continuous time: **day 630 / year 1.75** at observation **66**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
