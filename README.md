...
![Current PHYLUM world](renders/current.svg?gen=000038)

<!-- PHYLUM:STATE:START -->
**Observation:** `38`  
**Simulated time:** `day 238` / `year 0.66`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `931`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 0.66.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000038)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000038)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000038)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000038)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000038)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000038)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000038)
...
Continuous time: **day 238 / year 0.66** at observation **38**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
