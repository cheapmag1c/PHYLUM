...
![Current PHYLUM world](renders/current.svg?gen=000170)

<!-- PHYLUM:STATE:START -->
**Observation:** `170`  
**Simulated time:** `day 2086` / `year 5.79`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `889`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 5.79.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000170)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000170)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000170)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000170)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000170)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000170)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000170)
...
Continuous time: **day 2086 / year 5.79** at observation **170**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
