...
![Current PHYLUM world](renders/current.svg?gen=000138)

<!-- PHYLUM:STATE:START -->
**Observation:** `138`  
**Simulated time:** `day 1638` / `year 4.55`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `808`  
**Occupied cells:** `83` / `1440`  
**Active pathogens:** `3`  
**Predator/prey links:** `0`  
**Dominant lineage:** `pale filament`  
**Last checkpoint Δ:** `+1` organisms · `+0` occupied cells  
**Latest fossil:** VIVARIUM advances 14 simulated days to year 4.55.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000138)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000138)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000138)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000138)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000138)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000138)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000138)
...
Continuous time: **day 1638 / year 4.55** at observation **138**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
