...
![Current PHYLUM world](renders/current.svg?gen=000123)

<!-- PHYLUM:STATE:START -->
**Observation:** `123`  
**Simulated time:** `day 1428` / `year 3.97`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `795`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 3.97.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000123)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000123)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000123)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000123)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000123)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000123)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000123)
...
Continuous time: **day 1428 / year 3.97** at observation **123**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
