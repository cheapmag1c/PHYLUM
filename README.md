...
![Current PHYLUM world](renders/current.svg?gen=000159)

<!-- PHYLUM:STATE:START -->
**Observation:** `159`  
**Simulated time:** `day 1932` / `year 5.37`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `868`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 5.37.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000159)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000159)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000159)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000159)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000159)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000159)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000159)
...
Continuous time: **day 1932 / year 5.37** at observation **159**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
