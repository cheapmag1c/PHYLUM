...
![Current PHYLUM world](renders/current.svg?gen=000089)

<!-- PHYLUM:STATE:START -->
**Observation:** `89`  
**Simulated time:** `day 952` / `year 2.64`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `823`  
...
**Last checkpoint Δ:** `-1` organisms · `-2` occupied cells  
**Latest fossil:** VIVARIUM advances 14 simulated days to year 2.64.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000089)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000089)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000089)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000089)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000089)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000089)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000089)
...
Continuous time: **day 952 / year 2.64** at observation **89**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
