...
![Current PHYLUM world](renders/current.svg?gen=000173)

<!-- PHYLUM:STATE:START -->
**Observation:** `173`  
**Simulated time:** `day 2128` / `year 5.91`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `893`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 5.91.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000173)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000173)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000173)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000173)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000173)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000173)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000173)
...
Continuous time: **day 2128 / year 5.91** at observation **173**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
