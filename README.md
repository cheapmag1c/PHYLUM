...
![Current PHYLUM world](renders/current.svg?gen=000102)

<!-- PHYLUM:STATE:START -->
**Observation:** `102`  
**Simulated time:** `day 1134` / `year 3.15`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `796`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 3.15.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000102)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000102)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000102)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000102)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000102)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000102)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000102)
...
Continuous time: **day 1134 / year 3.15** at observation **102**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
