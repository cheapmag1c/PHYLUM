...
![Current PHYLUM world](renders/current.svg?gen=000168)

<!-- PHYLUM:STATE:START -->
**Observation:** `168`  
**Simulated time:** `day 2058` / `year 5.72`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `888`  
...
**Last checkpoint Δ:** `+8` organisms · `-1` occupied cells  
**Latest fossil:** VIVARIUM advances 14 simulated days to year 5.72.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000168)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000168)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000168)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000168)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000168)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000168)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000168)
...
Continuous time: **day 2058 / year 5.72** at observation **168**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
