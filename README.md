...
![Current PHYLUM world](renders/current.svg?gen=000096)

<!-- PHYLUM:STATE:START -->
**Observation:** `96`  
**Simulated time:** `day 1050` / `year 2.92`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `802`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 2.92.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000096)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000096)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000096)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000096)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000096)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000096)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000096)
...
Continuous time: **day 1050 / year 2.92** at observation **96**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
