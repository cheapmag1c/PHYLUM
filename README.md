...
![Current PHYLUM world](renders/current.svg?gen=000113)

<!-- PHYLUM:STATE:START -->
**Observation:** `113`  
**Simulated time:** `day 1288` / `year 3.58`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `786`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 3.58.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000113)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000113)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000113)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000113)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000113)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000113)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000113)
...
Continuous time: **day 1288 / year 3.58** at observation **113**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
