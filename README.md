...
![Current PHYLUM world](renders/current.svg?gen=000064)

<!-- PHYLUM:STATE:START -->
**Observation:** `64`  
**Simulated time:** `day 602` / `year 1.67`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `869`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 1.67.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000064)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000064)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000064)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000064)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000064)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000064)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000064)
...
Continuous time: **day 602 / year 1.67** at observation **64**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
