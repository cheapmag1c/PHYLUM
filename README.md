...
![Current PHYLUM world](renders/current.svg?gen=000027)

<!-- PHYLUM:STATE:START -->
**Observation:** `27`  
**Simulated time:** `day 84` / `year 0.23`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `916`  
**Occupied cells:** `71` / `1440`  
**Active pathogens:** `1`  
**Predator/prey links:** `0`  
**Dominant lineage:** `pale filament`  
**Last checkpoint Δ:** `+6` organisms · `+6` occupied cells  
**Latest fossil:** VIVARIUM advances 14 simulated days to year 0.23.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000027)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000027)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000027)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000027)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000027)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000027)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000027)
...
Continuous time: **day 84 / year 0.23** at observation **27**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
