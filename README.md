...
![Current PHYLUM world](renders/current.svg?gen=000184)

<!-- PHYLUM:STATE:START -->
**Observation:** `184`  
**Simulated time:** `day 2282` / `year 6.34`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `904`  
...
**Last checkpoint Δ:** `+11` organisms · `+0` occupied cells  
**Latest fossil:** VIVARIUM advances 14 simulated days to year 6.34.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000184)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000184)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000184)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000184)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000184)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000184)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000184)
...
Continuous time: **day 2282 / year 6.34** at observation **184**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
