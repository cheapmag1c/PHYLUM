...
![Current PHYLUM world](renders/current.svg?gen=000093)

<!-- PHYLUM:STATE:START -->
**Observation:** `93`  
**Simulated time:** `day 1008` / `year 2.80`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `810`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 2.80.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000093)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000093)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000093)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000093)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000093)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000093)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000093)
...
Continuous time: **day 1008 / year 2.80** at observation **93**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
