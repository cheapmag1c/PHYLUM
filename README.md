...
![Current PHYLUM world](renders/current.svg?gen=000079)

<!-- PHYLUM:STATE:START -->
**Observation:** `79`  
**Simulated time:** `day 812` / `year 2.26`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `855`  
...
**Last checkpoint Δ:** `+1` organisms · `+0` occupied cells  
**Latest fossil:** VIVARIUM advances 14 simulated days to year 2.26.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000079)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000079)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000079)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000079)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000079)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000079)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000079)
...
Continuous time: **day 812 / year 2.26** at observation **79**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
