...
![Current PHYLUM world](renders/current.svg?gen=000152)

<!-- PHYLUM:STATE:START -->
**Observation:** `152`  
**Simulated time:** `day 1834` / `year 5.09`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `842`  
...
**Last checkpoint Δ:** `+7` organisms · `+0` occupied cells  
**Latest fossil:** VIVARIUM advances 14 simulated days to year 5.09.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000152)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000152)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000152)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000152)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000152)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000152)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000152)
...
Continuous time: **day 1834 / year 5.09** at observation **152**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
