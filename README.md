...
![Current PHYLUM world](renders/current.svg?gen=000156)

<!-- PHYLUM:STATE:START -->
**Observation:** `156`  
**Simulated time:** `day 1890` / `year 5.25`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `856`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 5.25.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000156)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000156)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000156)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000156)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000156)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000156)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000156)
...
Continuous time: **day 1890 / year 5.25** at observation **156**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
