...
![Current PHYLUM world](renders/current.svg?gen=000139)

<!-- PHYLUM:STATE:START -->
**Observation:** `139`  
**Simulated time:** `day 1652` / `year 4.59`  
**Era:** `Origin Era`  
**Living lineages:** `3`  
**Extinct lineages:** `0`  
**Population:** `812`  
...
**Latest fossil:** VIVARIUM advances 14 simulated days to year 4.59.
<!-- PHYLUM:STATE:END -->


## Living phylogeny

![PHYLUM phylogeny](renders/phylogeny.svg?gen=000139)

## Living food web

![PHYLUM food web](renders/foodweb.svg?gen=000139)

## Persistent groups — SOCIUS

![PHYLUM SOCIUS social lineage record](renders/socius.svg?gen=000139)

## Living cultures — TECHNE

![PHYLUM TECHNE cultural record](renders/techne.svg?gen=000139)

## Living minds — NERVE

![PHYLUM NERVE ethogram](renders/nerve.svg?gen=000139)

## Planetary system — PALEON

![PHYLUM PALEON planetary system](renders/paleon.svg?gen=000139)

## Living organisms — SOMA

![PHYLUM SOMA field guide](renders/soma.svg?gen=000139)
...
Continuous time: **day 1652 / year 4.59** at observation **139**. Open [`docs/life.html`](docs/life.html) for the ORRERY **LIFE** view.
